...
const ShopItems = React.memo(() => {
    ...
    const renderNormalInfo = useCallback((item: ItemInfo) => {
        ...
        return (
            <div className="col-span-3 p-3 grid">
                <h3 className="font-extrabold text-lg mb-2">{name}</h3>
                <div>
            ...
            if (tileCounter < tileMax) {
              ...
              <span className="bg-zinc-900 bg-opacity-90 border p-2 rounded-md">
                Not available
                            ...
                            <div
                                className={`cursor-pointer bg-zinc-800 rounded-md overflow-hidden p-1 shadow-lg grid grid-cols-2`}
